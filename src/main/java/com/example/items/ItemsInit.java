...
public class ItemsInit {
    ...
    public static final Item CARROTS_SEEDS_ITEM = registerItem("carrots_seeds",new DefaultItem(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(PeopleMineSeason5.MOD_ID,"carrots_seeds"))).fireproof().rarity(Rarity.EPIC), Items.CARROT, "carrots_seeds"));
    public static final BlockItem CARROTS_SEEDS = new AliasedBlockItemPolymer(Blocks.CARROTS,new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(PeopleMineSeason5.MOD_ID,"carrots_seeds"))).component(DataComponentTypes.CUSTOM_NAME,Text.translatable("item.peoplemineseason5.carrots_seeds").setStyle(Style.EMPTY.withItalic(false).withColor(Formatting.GREEN))),CARROTS_SEEDS_ITEM);
